...
@Component({
  selector: 'app-architects-carousel',
  templateUrl: './architects-carousel.component.html',
  styleUrls: ['./architects-carousel.component.less']
})
export class ArchitectsCarouselComponent implements OnInit {
