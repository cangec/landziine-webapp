...
@Component({
  selector: 'app-studios-carousel',
  templateUrl: './studios-carousel.component.html',
  styleUrls: ['./studios-carousel.component.less']
})
export class StudiosCarouselComponent implements OnInit {
